...
$templates = array(
    array(
        ...
        "subject" => "Newsletter subscription success for {{var username}}"
    ),
    array(
    ...
    array(
        ...
        "subject" => "Thank You For Your Inquiry, {{var data.name}}!"
    ),
    array(
        "name" => "Helloday Abandoned Card",
        "code" => "helloday_abandoned_card_template",
        "subject" => "We saved your cart for you, *|FNAME|*"
    ),
    array(

...
class Customweb_BarclaycardCw_Block_ExternalCheckout_Widgets extends Mage_Core_Block_Template
{
    ...
    public function getWidgets()
    {
    	if (self::$_widgets == null) {
			self::$_widgets = Mage::getModel('barclaycardcw/externalCheckoutWidgets')->getAllWidgets();
    	}

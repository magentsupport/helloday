...
class Customweb_BarclaycardCw_Block_ExternalCheckout_ShippingMethods extends Mage_Core_Block_Template
{
	private $_context;
	...
	{
		parent::_construct();
		$this->setTemplate('customweb/barclaycardcw/external_checkout/shipping-methods.phtml');
	}

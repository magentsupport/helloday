<?php
class Customweb_BarclaycardCw_Block_Adminhtml_Sales_Order_Invoice_Edit  extends Mage_Adminhtml_Block_Widget_Form_Container
{
	public function __construct()
    {
        $this->_objectId = 'order_id';
        $this->_controller = 'customweb_barclaycardcw_invoice';
        $this->_mode = 'edit';

...
class Customweb_BarclaycardCw_Block_Adminhtml_BackendForm_Switcher extends Mage_Adminhtml_Block_Template
{
    protected function _prepareLayout()
    {
        $this->setTemplate('customweb/barclaycardcw/backendform/switcher.phtml');

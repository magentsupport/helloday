...
class Customweb_BarclaycardCw_Block_Adminhtml_BackendForm_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
	public function __construct()
	{
		parent::__construct();
		$this->setId('barclaycardcwbackendform_tabs');
		$this->setDestElementId('edit_form');
		$this->setTitle('Barclaycard');
	}

 ...
 * 
 */
class Customweb_BarclaycardCw_ConfigbarclaycardcwController extends Mage_Adminhtml_Controller_Action {

	protected function _isAllowed(){
		return Mage::getSingleton('admin/session')->isAllowed('system/barclaycardcw');
	}
	...
	protected function getHelper(){
		return Mage::helper('BarclaycardCw');
	}
	...
	public function indexAction(){
		...
		if (!empty($forms)){
			...
			$this->_title('Barclaycard');
			
			$this->_setActiveMenu('system/barclaycardcw');
	...
	public function viewAction(){
		...
		if (!empty($machineName)) {
			...
			$this->_addContent($this->getLayout()->createBlock('barclaycardcw/adminhtml_backendForm_form')->setForm($form));
		}
	...
	private function updateStoreHierarchy(){
		...
		Customweb_BarclaycardCw_Model_ConfigurationAdapter::setStoreHierarchy($storeHierarchy);
	}

...
class Customweb_BarclaycardCw_MotobarclaycardcwController extends Mage_Adminhtml_Controller_Action
{
	
	protected function _isAllowed()
	{
		return Mage::getSingleton('admin/session')->isAllowed('sales/barclaycardcw/barclaycardcw_moto');
	}
	...
	public function processAction()
	{
		...
		$this->getLayout()
			->getBlock('head')
			->addCss('css/barclaycardcw.css');
		$this->getLayout()
			->getBlock('content')
			->append($this->getLayout()
				->createBlock('barclaycardcw/moto'));

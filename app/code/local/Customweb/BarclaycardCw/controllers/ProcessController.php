...
class Customweb_BarclaycardCw_ProcessController extends Customweb_BarclaycardCw_Controller_Action
{
	...
	public function dummyAction()
	{
		...
		$this->getLayout()->getBlock('content')->append(
			$this->getLayout()->createBlock('barclaycardcw/dummy')
		);
	...
	public function getVisibleFieldsAction()
	{
		...
		if($payment != null){
			...
			$this->getHelper()->log("BarclaycardCw : ProcessController::getVisibleFieldsAction() Could not find payment method '" . $_REQUEST['payment_method']);
			$html = Mage::helper("BarclaycardCw")->__("Technical issue: This payment methods is not available at the moment.");
		}

 ...
 *
 */
class Customweb_BarclaycardCw_OnepageController extends Mage_Checkout_Controller_Action {

	/**
	 *
	 * @return Customweb_BarclaycardCw_OnepageController
	 */
	...
	protected function _getPaymentMethodsHtml(){
		...
		foreach($layout->getAllBlocks() as $block){
			if($block instanceof Customweb_BarclaycardCw_Block_Form){

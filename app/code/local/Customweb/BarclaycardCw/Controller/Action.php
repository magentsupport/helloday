 ...
 * 
 */
abstract class Customweb_BarclaycardCw_Controller_Action extends Mage_Core_Controller_Front_Action {
	...
	protected function getTransactionFromSession(){
		if (Mage::registry('cw_transaction') == null || !Mage::registry('cw_transaction')->getId()) {
			...
			$sessionTransactionId = Mage::getSingleton('core/session')->getBarclaycardCwTransactionId();

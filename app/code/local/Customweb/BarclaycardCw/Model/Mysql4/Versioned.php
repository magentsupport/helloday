...
abstract class Customweb_BarclaycardCw_Model_Mysql4_Versioned extends Mage_Core_Model_Mysql4_Abstract
{
	/**
	...
	public function save(Mage_Core_Model_Abstract $object)
	{
		...
		if (!is_null($object->getId()) && (!$this->_useIsObjectNew || !$object->isObjectNew())) {
			...
			if ($this->_isPkAutoIncrement) {
				...
				if($rowAffected == 0) {
					throw new Customweb_BarclaycardCw_Model_OptimisticLockingException(get_class($object), $object->getId());
				}

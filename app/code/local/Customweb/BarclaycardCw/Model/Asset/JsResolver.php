...
class Customweb_BarclaycardCw_Model_Asset_JsResolver implements Customweb_Asset_IResolver
{
	...
	private function getJsFilePath($identifier) {
		return Mage::getBaseDir() . '/js/customweb/barclaycardcw/assets/' . $identifier;
	}
	
	private function getJsUrl($identifier) {
		return Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_JS) . 'customweb/barclaycardcw/assets/' . $identifier;
	}
}
...
class Customweb_BarclaycardCw_Model_Asset_SkinResolver implements Customweb_Asset_IResolver
{
	...
	private function getSkinFilePath($identifier) {
		return Mage::getSingleton('core/design_package')->getFilename('customweb/barclaycardcw/assets/' . $identifier, array(
			'_type' => 'skin'
		));
	}
	
	private function getSkinUrl($identifier) {
		return Mage::getSingleton('core/design_package')->getSkinUrl('customweb/barclaycardcw/assets/' . $identifier);
	}
}
...
class Customweb_BarclaycardCw_Model_Asset_TemplateResolver implements Customweb_Asset_IResolver
{
	...
	private function getTemplateFilePath($identifier) {
		return Mage::getSingleton('core/design_package')->getTemplateFilename('customweb/barclaycardcw/assets/' . $identifier);
	}
}
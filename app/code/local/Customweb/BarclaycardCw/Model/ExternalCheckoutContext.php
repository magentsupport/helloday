 ...
 * 
 * 
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setContextId(int $value)
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setState(string $value)
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setFailedErrorMessage(string $value)
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setCartUrl(string $value)
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setDefaultCheckoutUrl(string $value)
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setOrderAmountInDecimals(double $value)
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setCurrencyCode(string $value)
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setLanguageCode(string $value)
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setCustomerEmailAddress(string $value)
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setCustomerId(int $value)
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setTransactionId(int $value)
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setShippingMethodName(string $value)
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setPaymentMethodMachineName(string $value)
 * @method string getCreatedOn()
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setCreatedOn(string $value)
 * @method string getUpdatedOn()
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setUpdatedOn(string $value)
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setSecurityToken(string $value)
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setSecurityTokenExpiryDate(string $value)
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setAuthenticationSuccessUrl(string $value)
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setAuthenticationEmailAddress(string $value)
 * @method int getQuoteId()
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setQuoteId(int $value)
 * @method string getRegisterMethod()
 * @method Customweb_BarclaycardCw_Model_ExternalCheckoutContext setRegisterMethod(string $value)
 * 
 */
class Customweb_BarclaycardCw_Model_ExternalCheckoutContext extends Mage_Core_Model_Abstract implements Customweb_Payment_ExternalCheckout_IContext 
{
	/**
	 *
	...
	{
		$this->_init('barclaycardcw/externalcheckoutcontext');
	}
	...
	protected function _afterLoad()
	{
		...
		$this->invoiceItems = Mage::helper('BarclaycardCw')->unserialize($this->getData('invoice_items'));
		$this->shippingAddress = Mage::helper('BarclaycardCw')->unserialize($this->getData('shipping_address'));
		$this->billingAddress = Mage::helper('BarclaycardCw')->unserialize($this->getData('billing_address'));
		$this->providerData = Mage::helper('BarclaycardCw')->unserialize($this->getData('provider_data'));
	...
	protected function _beforeSave()
	{
		...
		$this->setData('invoice_items', Mage::helper('BarclaycardCw')->serialize($this->invoiceItems));
		$this->setData('shipping_address', Mage::helper('BarclaycardCw')->serialize($this->shippingAddress));
		$this->setData('billing_address', Mage::helper('BarclaycardCw')->serialize($this->billingAddress));
		$this->setData('provider_data', Mage::helper('BarclaycardCw')->serialize($this->providerData));
	...
	private function collectInvoiceItems(Mage_Sales_Model_Quote $quote){
		return Mage::getModel('barclaycardcw/invoiceItems')->getInvoiceItems($quote, $quote->getStore()->getStoreId(), $this->useBaseCurrency());
	}
	...
	public function setInvoiceItems($value) {
		if (is_string($value)) {
			$this->invoiceItems = Mage::helper('BarclaycardCw')->unserialize($value);
		} else {
	...
	public function setShippingAddress($value) {
		if (is_string($value)) {
			$this->shippingAddress = Mage::helper('BarclaycardCw')->unserialize($value);
		} else {
	...
	public function setBillingAddress($value) {
		if (is_string($value)) {
			$this->billingAddress = Mage::helper('BarclaycardCw')->unserialize($value);
		} else {
	...
	public function setProviderData($value) {
		if (is_string($value)) {
			$this->providerData = Mage::helper('BarclaycardCw')->unserialize($value);
		} else {
	...
	public function getPaymentMethod() {
		...
		if ($this->paymentMethod == null && !empty($paymentMethodMachineName)) {
			$this->paymentMethod = Mage::helper('payment')->getMethodInstance('barclaycardcw_' . $paymentMethodMachineName);
		}

 ...
 * @method Customweb_BarclaycardCw_Model_Transaction setTransactionId(int $value)
 * @method string getTransactionExternalId()
 * @method Customweb_BarclaycardCw_Model_Transaction setTransactionExternalId(string $value)
 * @method int getOrderId()
 * @method Customweb_BarclaycardCw_Model_Transaction setOrderId(int $value)
 * @method int getOrderPaymentId()
 * @method Customweb_BarclaycardCw_Model_Transaction setOrderPaymentId(int $value)
 * @method string getAliasForDisplay()
 * @method Customweb_BarclaycardCw_Model_Transaction setAliasForDisplay(string $value)
 * @method boolean getAliasActive()
 * @method Customweb_BarclaycardCw_Model_Transaction setAliasActive(boolean $value)
 * @method string getPaymentMethod()
 * @method Customweb_BarclaycardCw_Model_Transaction setPaymentMethod(string $value)
 * @method Customweb_Payment_Authorization_ITransaction getTransactionObject()
 * @method Customweb_BarclaycardCw_Model_Transaction setTransactionObject(Customweb_Payment_Authorization_ITransaction $value)
 * @method string getAuthorizationType()
 * @method Customweb_BarclaycardCw_Model_Transaction setAuthorizationType(string $value)
 * @method int getCustomerId()
 * @method Customweb_BarclaycardCw_Model_Transaction setCustomerId(int $value)
 * @method string getUpdatedOn()
 * @method Customweb_BarclaycardCw_Model_Transaction setUpdatedOn(string $value)
 * @method string getCreatedOn()
 * @method Customweb_BarclaycardCw_Model_Transaction setCreatedOn(string $value)
 * @method string getPaymentId()
 * @method Customweb_BarclaycardCw_Model_Transaction setPaymentId(string $value)
 * @method boolean getUpdatable()
 * @method Customweb_BarclaycardCw_Model_Transaction setUpdatable(boolean $value)
 * @method string getExecuteUpdateOn()
 * @method Customweb_BarclaycardCw_Model_Transaction setExecuteUpdateOn(string $value)
 * @method float getAuthorizationAmount()
 * @method Customweb_BarclaycardCw_Model_Transaction setAuthorizationAmount(float $value)
 * @method string getAuthorizationStatus()
 * @method Customweb_BarclaycardCw_Model_Transaction setAuthorizationStatus(string $value)
 * @method boolean getPaid()
 * @method Customweb_BarclaycardCw_Model_Transaction setPaid(boolean $value)
 * @method string getCurrency()
 * @method Customweb_BarclaycardCw_Model_Transaction setCurrency(string $value)
 * @method int getVersionNumber();
 * @method Customweb_BarclaycardCw_Model_Transaction setVersionNumber(int $value)
 * @method boolean isLiveTransaction();
 * @method Customweb_BarclaycardCw_Model_Transaction setLiveTransaction(boolean $value)
 */
class Customweb_BarclaycardCw_Model_Transaction extends Mage_Core_Model_Abstract
{
	...
	{
		$this->_init('barclaycardcw/transaction');
	}
	...
	protected function _afterLoad()
	{
		...
		if (is_string($this->getTransactionObject())) {
			$this->setTransactionObject(Mage::helper('BarclaycardCw')->unserialize($this->getTransactionObject()));
			$orderId = $this->getOrderId();
			if (!empty($orderId)) {
				Customweb_BarclaycardCw_Model_ConfigurationAdapter::setStore($this->getOrder());
			}
	...
	protected function _beforeSave()
	{
		...
		if ($this->getTransactionObject() !== null && $this->getTransactionObject() instanceof Customweb_Payment_Authorization_ITransaction) {
			...
			if ($this->uncertain !== $this->getTransactionObject()->isAuthorizationUncertain() && !$this->getTransactionObject()->isAuthorizationUncertain()) {
				/**
				 * @var $paymentMethod Customweb_BarclaycardCw_Model_Method
				 */
				$paymentMethod = $this->getTransactionObject()->getPaymentMethod();
				Mage::register('barclaycardcw_update_transaction', $this);
				$paymentMethod->createInvoiceAfterUncertain($this);
				Mage::unregister('barclaycardcw_update_transaction');
			}
			$this->uncertain = $this->getTransactionObject()->isAuthorizationUncertain();
		...
		if (!is_string($this->getTransactionObject())) {
			$this->setTransactionObject(Mage::helper('BarclaycardCw')->serialize($this->getTransactionObject()));
		}
	}
	...
	protected function _afterSave()
	{
		...
		if ($this->getAliasActive() && $this->getAliasForDisplay() !== null) {
			$collection = Mage::getModel('barclaycardcw/transaction')->getCollection()
	...
	protected function updateOrderStatus($orderStatus, $orderStatusSettingKey) {
		try {
			...
			if ($order->getStatus() == Customweb_BarclaycardCw_Model_Method::BARCLAYCARDCW_STATUS_PENDING) {
				$notifyCustomer = true;
			}

 ...
 * @Bean
 */
class Customweb_BarclaycardCw_Model_TransactionHandler extends Mage_Core_Model_Abstract implements Customweb_Payment_ITransactionHandler
{
	private $cache = array(
	 ...
	 * @return Customweb_BarclaycardCw_Model_Transaction|null
	 */
	private function loadTransaction($value, $field, $useCache) {
		...
		$transaction = Mage::getModel('barclaycardcw/transaction')->load($value, $field);

 ...
 * @Bean
 */
class Customweb_BarclaycardCw_Model_UpdateHandler implements Customweb_Payment_Update_IHandler
{
	public function getContainer() {
		return Mage::helper('BarclaycardCw')->createContainer();
	}
	...
	public function log($message, $type) {
		...
		Mage::helper('BarclaycardCw')->log($message, $level);
	}

	public function getScheduledTransactionIds() {
		$resource = Mage::getSingleton('core/resource');
		$readConnection = $resource->getConnection('core_read');
		$query = 'SELECT transaction_id FROM ' . $resource->getTableName('barclaycardcw/transaction')

 ...
 * @Bean
 */
class Customweb_BarclaycardCw_Model_LayoutRenderer extends Customweb_Mvc_Layout_Renderer
{
	public function render(Customweb_Mvc_Layout_IRenderContext $context) {
		...
		$layout->getBlock('head')->addCss('customweb/barclaycardcw/updates.css');

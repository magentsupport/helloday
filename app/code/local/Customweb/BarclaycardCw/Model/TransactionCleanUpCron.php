 ...
 */
class Customweb_BarclaycardCw_Model_TransactionCleanUpCron {
	...
	public function cleanUp() {
		...
		$failedCollection = Mage::getModel('barclaycardcw/transaction')->getCollection()
		...
		$pendingCollection = Mage::getModel('barclaycardcw/transaction')->getCollection()
		...
		$noStatusCollection = Mage::getModel('barclaycardcw/transaction')->getCollection()

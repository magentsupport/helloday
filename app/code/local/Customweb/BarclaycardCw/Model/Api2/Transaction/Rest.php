...
class Customweb_BarclaycardCw_Model_Api2_Transaction_Rest extends Customweb_BarclaycardCw_Model_Api2_Transaction
{
	...
	{
		$transaction = Mage::getModel('barclaycardcw/transaction')->load($id);
	...
	protected function prepareEntry(Customweb_BarclaycardCw_Model_Transaction $transaction)
	{

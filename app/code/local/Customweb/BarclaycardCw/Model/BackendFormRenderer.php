...
class Customweb_BarclaycardCw_Model_BackendFormRenderer extends Customweb_Form_Renderer
{
	private $formId = null;
	...
	public function __construct()
	{
		...
		$this->setControlCssClassResolver(Mage::getModel('barclaycardcw/controlCssClassResolver'));
	...
	{
		if (Mage::getModel('barclaycardcw/configurationAdapter')->getStoreHierarchy() == null) {
			return '';
		}
	...
	protected function renderElementScopeControl(Customweb_Form_IElement $element)
	{
		...
		$output .= '<label for="' . $scopeControlId . '">' . Mage::helper('BarclaycardCw')->__('Use Default') . '</label>';
		return $output;
	}
	...
	{
		$storeHierarchy = Mage::getModel('barclaycardcw/configurationAdapter')->getStoreHierarchy();

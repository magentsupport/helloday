...
class Customweb_BarclaycardCw_Model_Transaction_Api extends Mage_Api_Model_Resource_Abstract
{
    ...
    protected function prepareEntry(Customweb_BarclaycardCw_Model_Transaction $transaction, $attributes = null)
    {
    	...
    	if (is_string($transaction->getTransactionObject())) {
    		$transaction->setTransactionObject(Mage::helper('BarclaycardCw')->unserialize($transaction->getTransactionObject()));
    	}

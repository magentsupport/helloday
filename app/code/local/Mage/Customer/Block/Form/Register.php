...
class Mage_Customer_Block_Form_Register extends Mage_Directory_Block_Data {
    ...
    protected function _prepareLayout() {
        $this->getLayout()->getBlock('head')
                ->setTitle(Mage::helper('customer')->__('My Account | Create An Account | Hello Day'))
                ->setDescription('Create an account with Hello Day to secure faster checkout, save shipping addresses & track orders.');

...
class Magestore_Bannerslider_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    public function getValueToXml($keyIndex, $itemCollection){
     ...
     /**
     * Use for display Category and Subcategories 
     * in Category page (Arvind) 24-Dec-2016
     */
    public function getCustomMenuCategory($categoryId = NULL) {
        ...
        try {
            ...
            Mage::log($ex, null, 'subcategoryMenu.log');
        }
    }

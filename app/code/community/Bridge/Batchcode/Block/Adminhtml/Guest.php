 ...
 */
class Bridge_Batchcode_Block_Adminhtml_Guest extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_controller = 'adminhtml_guest';
        $this->_blockGroup = 'batchcode';
        $batch_code = $this->getBatchCode();

        $this->_headerText = Mage::helper('batchcode')->__('Guest of batch code : ') . $batch_code;
        parent::__construct();

...
?>
<?php
class Bridge_Batchcode_Block_Adminhtml_Sales_Order_View_Tab_Shipments extends Mage_Adminhtml_Block_Widget_Grid implements Mage_Adminhtml_Block_Widget_Tab_Interface {
    ...
    protected function _prepareColumns() {
        ...
        /* batch code field */
        $this->addColumn('batchcode', array(
            'header' => Mage::helper('sales')->__('Batch Code'),
            'index' => 'batchcode',
        ));
        /* batch code field */

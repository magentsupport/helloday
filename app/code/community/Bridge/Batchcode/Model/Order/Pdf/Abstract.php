 ...
 * @license       http://bridge-india.in/disclaimer/magento
 */
abstract class Bridge_Batchcode_Model_Order_Pdf_Abstract extends Mage_Sales_Model_Order_Pdf_Abstract {
     ...
     * @return Zend_Pdf_Page
     */
    protected function _drawItem(Varien_Object $item, Zend_Pdf_Page $page, Mage_Sales_Model_Order $order, Bridge_Batchcode_Model_Order_Item $batch) {

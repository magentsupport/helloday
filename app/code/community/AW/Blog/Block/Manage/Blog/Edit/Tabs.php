    ...
    protected function _beforeToHtml()
    {
        ...
        $this->addTab(
          ...
          $this->addTab(
            'products_section',
            array(
                 'label'   => Mage::helper('blog')->__('Select Products'),
                 'title'   => Mage::helper('blog')->__('Select Products'),
                 'content' => $this->getLayout()->createBlock('blog/manage_blog_edit_tab_products')->toHtml(),
            )
        );

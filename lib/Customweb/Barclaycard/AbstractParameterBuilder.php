...
abstract class Customweb_Barclaycard_AbstractParameterBuilder {
	...
	protected function getCustomerParameters(){
		$parameters = array(
			'CN' => $this->cleanStringParameter(Customweb_Barclaycard_Util::substrUtf8(
			...
			'OWNERZIP' => Customweb_Barclaycard_Util::substrUtf8($this->getTransactionContext()->getOrderContext()->getBillingPostCode(), 0, 
					10),
			'OWNERADDRESS' => $this->cleanStringParameter(Customweb_Barclaycard_Util::substrUtf8($this->getTransactionContext()->getOrderContext()->getBillingStreet(), 0, 
					50)),
			'OWNERTOWN' => $this->cleanStringParameter(Customweb_Barclaycard_Util::substrUtf8($this->getTransactionContext()->getOrderContext()->getBillingCity(), 0, 40)),
	...
	protected function getDeliveryAndInvoicingParameters(){
		$parameters = array(
			'ECOM_BILLTO_POSTAL_CITY' => $this->cleanStringParameter(Customweb_Barclaycard_Util::substrUtf8(
			...
			'ECOM_BILLTO_POSTAL_NAME_FIRST' => $this->cleanStringParameter(Customweb_Barclaycard_Util::substrUtf8(
					$this->getTransactionContext()->getOrderContext()->getBillingFirstName(), 0, 35)),
			'ECOM_BILLTO_POSTAL_NAME_LAST' => $this->cleanStringParameter(Customweb_Barclaycard_Util::substrUtf8(
					$this->getTransactionContext()->getOrderContext()->getBillingLastName(), 0, 35)),
			'ECOM_BILLTO_POSTAL_POSTALCODE' => $this->cleanStringParameter(Customweb_Barclaycard_Util::substrUtf8(
					$this->getTransactionContext()->getOrderContext()->getBillingPostCode(), 0, 10)),
			'ECOM_BILLTO_POSTAL_STREET_LINE1' => $this->cleanStringParameter(Customweb_Barclaycard_Util::substrUtf8(
					$this->getTransactionContext()->getOrderContext()->getBillingStreet(), 0, 35)),
			
			'ECOM_SHIPTO_POSTAL_CITY' => $this->cleanStringParameter(Customweb_Barclaycard_Util::substrUtf8(
			...
			'ECOM_SHIPTO_POSTAL_NAME_FIRST' => $this->cleanStringParameter(Customweb_Barclaycard_Util::substrUtf8(
					$this->getTransactionContext()->getOrderContext()->getShippingFirstName(), 0, 35)),
			'ECOM_SHIPTO_POSTAL_NAME_LAST' => $this->cleanStringParameter(Customweb_Barclaycard_Util::substrUtf8(
					$this->getTransactionContext()->getOrderContext()->getShippingLastName(), 0, 35)),
			'ECOM_SHIPTO_POSTAL_POSTALCODE' => $this->cleanStringParameter(Customweb_Barclaycard_Util::substrUtf8(
					$this->getTransactionContext()->getOrderContext()->getShippingPostCode(), 0, 10)),
			'ECOM_SHIPTO_POSTAL_STREET_LINE1' => $this->cleanStringParameter(Customweb_Barclaycard_Util::substrUtf8(

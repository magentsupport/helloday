    ...
    SliderObject = function(a, b) {
        if (jQuery(window).width() < 768) {
            if (jQuery('#mobile-slide').hasClass('home-page-mobile')) {
                ...
                jQuery(".home-page-mobile").removeClass('loader-slider');
            }
        } else {
            jQuery('.home-page-mobile').remove();
            jQuery('.desktop-page-slider').removeClass('loader-slider');
        }
        ...
        create: function(a, b) {
            ...
            if (!b['width']) {
                ...
                e.children().each(function() {
                    if ($(this).is("img")) {
                        f['width'] = jQuery(".danger-slider_1").height()
                        f['height'] = $(this).outerHeight();
                        b['width'] = (f['width'] >= b['width']) ? f['width'] : 0;
                        b['height'] = jQuery(".danger-slider_1").height()
                    }
                });
                delete f;
            ...
            this.esqueleto.wrapper.css({
                ...
                'height': this.options.height //jQuery(".danger-slider_1").height()
            });
            this.element.css({
                'width': this.options.width,
                'height': this.options.height, //jQuery(".danger-slider_1").height(),
            ...
            if (this.options.navigation) {
                ...
                var j = $('<a href="#" title="Prev" alt="Prev" class="' + this.options.name + '-navigation-prev" rel="-1"><span>Prev</span></a>');
                var k = $('<a href="#" title="Next" alt="Next" class="' + this.options.name + '-navigation-next" rel="+1"><span>Next</span></a>');
                this.esqueleto.navigation.append(j, k)
            }
            if (this.options.control) {
                this.esqueleto.control = $('<a href="#" title="Play/Pause" alt="Play/Pause" class="' + this.options.name + '-control ' + this.options.name + '-control-pause"><span>Play/Pause</span></a>').insertAfter(a)
            }
            ...
            if (this.options.slideshow) {
                ...
                if (jQuery("#mobile-slide").hasClass('home-page-mobile')) {
                    ...
                    var sliderheight = jQuery(".jquery-slider-slide img").outerHeight();
                    if (sliderheight == '0') {
                        var sliderheight = jQuery(window).width() / 3;
                    }
                    jQuery(".slider-main-div").css("height", sliderheight);
                    jQuery(".jquery-slider-wrapper").css("height", sliderheight);
                    //jQuery(".bannerslide-caborno-slider").css("height",sliderheight); 
                }
                this.startTimer()
            } else {
                this.stopTimer()

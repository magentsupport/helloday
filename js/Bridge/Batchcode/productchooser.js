    ...
    new Ajax.Request(
        url, {
            ...
            onSuccess: function (b) {
                ...
                //   a.show();
                a.scrollTo();
                rule_conditions_fieldset.initialize();
...
var rule_conditions_fieldset = {
    ...
    chooserGridCheckboxCheck: function (grid, element, checked) {
        ...
        // Use this only if it is a radio button
        for (var i=0; i<this.chooserSelectedItems.keys().length; i++) {
            this.chooserSelectedItems.unset(this.chooserSelectedItems.keys()[i]);
        }
        ...
        this.updateElement.value = element.value; // Use this only if it is a radio button
    }
}
